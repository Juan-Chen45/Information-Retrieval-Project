...
class VectorSpaceIndex:
    ...
    def storeIndex():
        with open(r"Index/VectorIndex", "wb")as f:
            Cpickle.dump(VectorSpaceIndex.vertor_space_index, f)
        with open(r"Index/VectorIndexDocLen", "wb")as f:
            Cpickle.dump(VectorSpaceIndex.doc_len, f)
        with open(r"Index/Vectorcnt","wb")as f:
            Cpickle.dump(VectorSpaceIndex.cnt,f)

    @staticmethod
    def loadIndex():
        with open(r"Index/VectorIndex", "rb")as f:
            VectorSpaceIndex.vertor_space_index = Cpickle.load(f)
        with open(r"Index/VectorIndexDocLen", "rb")as f:
            VectorSpaceIndex.doc_len = Cpickle.load(f)
        with open(r"Index/Vectorcnt","rb")as f:
            VectorSpaceIndex.cnt = Cpickle.load(f)
